        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            <div className="flex items-center space-x-3 mb-4">
              ...
              <div>
                <h3 className="text-2xl font-bold">Aaron & Huri Ministry</h3>
                <p className="text-gray-400">Supporting children's education</p>
              </div>
            </div>
            <p className="text-gray-300 mb-6 max-w-md">
              We are dedicated to supporting children's education by paying school fees 
        ...
        <div className="border-t border-gray-800 mt-8 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-gray-400 text-sm">
              © 2024 Aaron & Huri Ministry. All rights reserved.
            </p>
